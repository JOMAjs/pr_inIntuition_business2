...
INSERT INTO `mis_favoritos` (`id`, `usuario_id`, `comida_favorita`, `lugar_favorito`, `artista_favorito`, `color_favorito`, `imagen`) VALUES
	(1, 'd4e5312d093a71f2061da423d8efd5d9', 'frijoles con arroz', 'malecom cucuta', 'mana', 'azul', 'avatar5.png'),
	(2, 'd3c994ccd5df48a08c4117d5256a53e9', 'bandeja Paisa Colombia', 'parque de las palomas', 'Mana', 'azul, negro, rojo', 'avatar2.png');
...
INSERT INTO `registro` (`id`, `token`, `nombre`, `apellido`, `sele_telefono`, `telefono`, `pais`, `email`, `contrasena`, `intentos`, `fecha`, `estado`) VALUES
	(1, 'd4e5312d093a71f2061da423d8efd5d9', 'dev', 'php', '+57', '3257690532', 'CO', 'php@gmail.com', '$2a$07$cursophpadsliveandrese7WY1WyNNBxAFyeMJnNiUAtvjJJuqLm6', '0', NULL, 1),
	(2, 'd3c994ccd5df48a08c4117d5256a53e9', 'bella', 'camalidades', '+57', '9999999999', 'CO', 'bella@gmail.com', '$2a$07$cursophpadsliveandrese7WY1WyNNBxAFyeMJnNiUAtvjJJuqLm6', '0', NULL, 2);
